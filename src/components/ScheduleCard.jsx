...
function ScheduleCard() {
  return (
    <div className="flex items-center justify-between border px-8 py-3 rounded font-medium text-[#606060] bg-slate-50 w-full h-fit hover:shadow-lg transition-all duration-500">
